...
const WELCOME_LETTERS = [
  ...
  { id: 'm1', d: 'M459.037 529.75H471.037L486.862 586H474.862L465.037 550.975L461.137 564.7L467.137 586H455.137L445.312 551.05L435.412 586H423.412L439.312 529.75H451.312L455.137 543.4L459.037 529.75Z' },
  { id: 'e2', d: 'M534.223 586H506.473C495.898 586 490.648 581.275 490.648 571.525C490.648 562.825 494.923 558.025 503.473 557.2C497.923 555.55 495.148 551.125 495.148 543.85C495.148 534.325 499.873 529.75 509.323 529.75H534.223V541.75H512.923C510.223 541.75 508.648 543.925 508.648 546.625C508.648 549.1 510.223 551.575 512.923 551.575H528.223V563.425H508.648C505.723 563.425 504.148 566.05 504.148 568.825C504.148 571.75 505.723 574 508.648 574H534.223V586Z' },
  { id: 't1', d: 'M583.817 586V541.75H567.992V529.75H611.642V541.75H595.817V586H583.817Z' },
...
const TAGLINE_LETTERS = [
  ...
  { id: 'tag17', d: 'M1724.03 540.695C1720.07 540.365 1718.09 542.075 1718.09 545.825V546.5H1724.03V550.28H1718.09V569H1714.17V550.28H1710.57V546.5H1714.17V545.825C1714.17 542.795 1715.01 540.5 1716.69 538.94C1718.4 537.38 1720.85 536.705 1724.03 536.915V540.695Z' },
  { id: 'tag18', d: 'M1531.56 624.585C1529.29 624.585 1527.28 624.105 1525.54 623.145C1523.8 622.185 1522.52 620.79 1521.71 618.96L1525.27 616.89C1526.2 619.29 1528.3 620.49 1531.56 620.49C1533.58 620.49 1535.15 620.01 1536.29 619.05C1537.43 618.09 1538 616.665 1538 614.775V592.5H1542.14V614.775C1542.14 617.925 1541.14 620.355 1539.13 622.065C1537.15 623.745 1534.63 624.585 1531.56 624.585Z' },
  { id: 'tag19', d: 'M1568.33 624L1565.77 616.935H1551.59L1549.03 624H1544.57L1556.32 592.5H1561.04L1572.79 624H1568.33ZM1553.03 613.02H1564.33L1558.66 597.495L1553.03 613.02Z' },
  { id: 'tag20', d: 'M1598.91 624H1594.14L1586.4 611.58L1578.66 624H1573.94L1584.06 607.8L1574.52 592.5H1579.25L1586.4 603.975L1593.56 592.5H1598.28L1588.79 607.755L1598.91 624Z' },
  { id: 'tag21', d: 'M1632.52 592.5V624H1628.38V599.385L1618.08 616.53H1617.54L1607.23 599.43V624H1603.05V592.5H1607.77L1617.81 609.15L1627.8 592.5H1632.52Z' },
  { id: 'tag22', d: 'M1660 624L1657.44 616.935H1643.26L1640.7 624H1636.24L1647.99 592.5H1652.71L1664.46 624H1660ZM1644.7 613.02H1656L1650.33 597.495L1644.7 613.02Z' },
  { id: 'tag23', d: 'M1686.85 624L1679.78 611.94H1672.36V624H1668.17V592.5H1680.77C1683.47 592.5 1685.78 593.46 1687.7 595.38C1689.62 597.27 1690.58 599.565 1690.58 602.265C1690.58 604.305 1689.97 606.165 1688.74 607.845C1687.54 609.525 1685.98 610.71 1684.06 611.4L1691.48 624H1686.85ZM1672.36 596.415V608.16H1680.77C1682.33 608.16 1683.65 607.59 1684.73 606.45C1685.84 605.28 1686.4 603.885 1686.4 602.265C1686.4 600.645 1685.84 599.265 1684.73 598.125C1683.65 596.985 1682.33 596.415 1680.77 596.415H1672.36Z' },
  { id: 'tag24', d: 'M1715.19 592.5V596.46H1705.87V624H1701.73V596.46H1692.46V592.5H1715.19Z' },
];
...
export default function Splash({ onClick, onStartTransition, onComplete }: SplashProps) {
  ...
  // Background Glow component references
  ...
  useIsomorphicLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 2. Subtle Ambient Glow Pulse on Background Gradients
  ...
  // ─── Smooth & Premium GSAP Splash Transition ───
  const startTransition = useCallback(() => {
    if (transitionStartedRef.current) return;
    transitionStartedRef.current = true;

    // Immediately trigger landing page mount underneath splash in page.tsx
    onStartTransition?.();
    ...
    // Kill existing idle loops on elements
    ...
    if (mascotRef.current) {
      ...
      // 0.20s - 0.40s: Mascot smooth settle (scale 1.035 -> 1.02, y: -5 -> 0)
      tl.to(
        mascotRef.current,
        {
          scale: 1.02,
      ...
      // 0.40s - 0.95s: Mascot gently follows camera (scale 1.02 -> 1.05)
      tl.to(
        mascotRef.current,
        {
          scale: 1.05,
      ...
      // 0.65s - 0.95s: Mascot soft fade near end
      tl.to(
        mascotRef.current,
        {
          autoAlpha: 0,
    ...
    // 0.10s - 0.95s: Scene Camera gentle zoom (scale 1 -> 1.08)
    if (sceneRef.current) {
      tl.to(
        sceneRef.current,
        {
    ...
    // 0.15s - 0.95s: Background depth movement (slower scale 1 -> 1.03)
    if (bgGlowsGroupRef.current) {
      tl.to(
        bgGlowsGroupRef.current,
        {
          scale: 1.03,
          duration: 0.8,
          ease: 'power2.inOut',
    ...
    // 0.30s - 0.65s: "WELCOME TO" group fades and lifts slightly
    if (welcomeGroupRef.current) {
      tl.to(
        welcomeGroupRef.current,
        {
          autoAlpha: 0,
          y: -10,
          scale: 0.99,
    ...
    // 0.38s - 0.73s: Tagline group fades and lifts slightly (starts after WELCOME TO)
    if (taglineGroupRef.current) {
      tl.to(
        taglineGroupRef.current,
        {
          autoAlpha: 0,
          y: -8,
          duration: 0.35,
    ...
    // 0.25s - 0.80s: JLT Logo follows camera subtly (scale 1 -> 1.04, y: 0 -> -3px) and fades
    if (jltSolidRef.current) {
      tl.to(
        jltSolidRef.current,
        {
          scale: 1.04,
    ...
    // 0.45s - 0.85s: Glow gentle expansion (scale 1 -> 1.08, opacity 0.7 -> 0.9 -> 0)
    if (glowElements.length > 0) {
      tl.to(
        glowElements,
        {
    ...
    // 0.75s - 0.95s: Final seamless dissolve into landing page
    if (containerRef.current) {
      tl.to(
  ...
  }, [onClick, onStartTransition, onComplete]);

  // Auto-transition to main landing page after delay (850ms)
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* ─── Master Visual Scene (Camera Wrapper) ─── */}
      <div
        ref={sceneRef}
      ...
      >
        {/* ─── Exact Figma SVG Artwork & Glow Depth Layer ─── */}
        <svg
          ref={svgRef}
        ...
        >
          ...
          <g clipPath="url(#hero_clip0)">
            ...
            {/* ─── Background Glows Group (Depth / Parallax Layer) ─── */}
            <g
              ref={bgGlowsGroupRef}
              style={{
            ...
            >
              ...
              <g
                ref={glow0Ref}
                filter="url(#hero_filter0)"
                style={{
                  willChange: 'transform, opacity',
                  transformOrigin: '1934px 35px',
                }}
              >
                <path
              ...
              <g
                ref={glow1Ref}
                filter="url(#hero_filter1)"
                style={{
                  willChange: 'transform, opacity',
                  transformOrigin: '1934px 1690px',
                }}
              >
                <path
              ...
              {/* Left/Bottom-Left Background Glows */}
              <g
                ref={glow2Ref}
                filter="url(#hero_filter2)"
                style={{
                  willChange: 'transform, opacity',
            ...
            {/* ─── "WELCOME TO" Typography (Intact Single Group) ─── */}
            <g
              ref={welcomeGroupRef}
              style={{
                transformOrigin: '420px 558px',
                willChange: 'transform, opacity',
              }}
            >
            ...
            {/* ─── "A TRUSTED PARTNER OF JAXMART" Tagline Typography (Intact Single Group) ─── */}
            <g
              ref={taglineGroupRef}
              style={{
                transformOrigin: '1620px 550px',
                willChange: 'transform, opacity',
              }}
            >
            ...
            {/* ─── JLT Solid Logo (100% Intact Vector Hero) ─── */}
            <g
              ref={jltSolidRef}
              style={{
                transformOrigin: '1280px 580px',
                willChange: 'transform, opacity',
              }}
            >
              <path
        ...
        {/* ─── Mascot (Full Character 100% Intact Hero) ─── */}
        <img
          ref={mascotRef}
          ...
          decoding="async"
          fetchPriority="high"
          className="absolute left-[50%] md:left-[47%] top-[50%] md:top-[53%] -translate-x-[50%] -translate-y-[50%] w-[55vw] sm:w-[40vw] md:w-[24vw] max-w-[460px] h-auto object-contain z-10 pointer-events-none drop-shadow-[0_20px_40px_rgba(0,0,0,0.6)]"
          style={{
            transformOrigin: 'center center',
            willChange: 'transform, opacity',
          }}
