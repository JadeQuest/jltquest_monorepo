...
const StreakCardComponent: React.FC = () => {
  ...
  return (
    <div className="daily-card-panel p-4 sm:p-6 flex items-center justify-between h-[180px] sm:h-[260px] relative overflow-hidden group">
      ...
      <div className="flex flex-col gap-1 z-10 pl-2">
        <div className="text-white font-gilroyBold text-3xl sm:text-5xl font-extrabold tracking-tight">
          {streak}
        </div>
        <div className="text-purple-200 font-gilroyBold text-sm sm:text-xl font-bold tracking-wide">
          {streak === 1 ? 'Day' : 'Days'}
        </div>
      </div>

      {/* South-East Flame graphic - Slightly larger (w-[215px] h-[260px]) */}
      <div className="absolute -right-3 sm:-right-5 -bottom-3 sm:-bottom-7 w-[100px] h-[120px] sm:w-[215px] sm:h-[260px] flex items-center justify-center animate-flame z-10 pointer-events-none">
        <Image
          src="/icon/flame.webp"
          alt="Flame Badge"
          fill
