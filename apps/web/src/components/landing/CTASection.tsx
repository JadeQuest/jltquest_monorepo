      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-10 text-center relative z-10">
        ...
        <div className="flex items-center gap-6">
          {[1, 2, 3].map((i) => (
            ...
            >
              <img src="/icon/coin.avif" alt="JLT Coin" width={24} height={24} loading="lazy" decoding="async" className="w-6 h-6 object-contain animate-sparkle" style={{ animationDelay: `${i * 0.3}s` }} />
