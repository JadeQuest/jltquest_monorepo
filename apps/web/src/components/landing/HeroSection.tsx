            ...
            <div className="w-full max-w-md glass-panel p-6 sm:p-7 flex flex-col gap-6 relative z-10 border border-white/15 shadow-[0_25px_60px_rgba(0,0,0,0.7)] backdrop-blur-2xl transition-all duration-300 hover:border-white/25">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-white/10">
                ...
                <div className="glass-pill px-3.5 py-1.5 flex items-center gap-2 border border-amber-500/40 bg-amber-500/10 relative shadow-[0_0_15px_rgba(251,191,36,0.2)]">
                  <img src="/icon/coin.avif" alt="Coin" width={20} height={20} className="w-5 h-5 object-contain animate-bounce" style={{ animationDuration: '2.5s' }} />
              ...
              <div className="flex items-center justify-between gap-2 pt-1">
                ...
                <div className="flex items-center gap-2.5">
                  <div className="group relative cursor-pointer" title="Mythic Pass">
                    <img src="/card/collect-1.avif" alt="Pass 1" width={36} height={40} loading="lazy" decoding="async" className="w-9 h-9 object-contain transform group-hover:scale-125 transition-transform duration-200 drop-shadow-[0_0_8px_rgba(255,162,141,0.5)]" />
                  </div>
                  <div className="group relative cursor-pointer" title="Rare Drop">
                    <img src="/card/collect-2.avif" alt="Pass 2" width={36} height={44} loading="lazy" decoding="async" className="w-9 h-9 object-contain transform group-hover:scale-125 transition-transform duration-200 drop-shadow-[0_0_8px_rgba(123,44,191,0.5)]" />
                  </div>
                  <div className="group relative cursor-pointer" title="Gold Pass">
                    <img src="/card/collect-3.avif" alt="Pass 3" width={36} height={43} loading="lazy" decoding="async" className="w-9 h-9 object-contain transform group-hover:scale-125 transition-transform duration-200 drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]" />
                  </div>
                </div>
              </div>
